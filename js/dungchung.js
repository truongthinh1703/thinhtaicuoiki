    ...
    <div class="top-nav group">
        <section>
            <div class="social-top-nav">
                <a href="https://www.facebook.com/profile.php?id=100011943756627" target="_blank" class="fa fa-facebook"></a>
                <a href="https://twitter.com/" target="_blank" class="fa fa-twitter"></a>
                <a href="https://www.google.com/" target="_blank" class="fa fa-google"></a>
                <a href="https://www.youtube.com/@cristiano" target="_blank" class="fa fa-youtube"></a>
...
function addHeader() {
	...
	<div class="header group">
        <div class="logo">
            <a href="index.html">
                <img src="img/logo8.jpg" alt="Trang chủ Smartphone Store" title="Trang chủ Smartphone Store">
            </a>
        </div> <!-- End Logo -->
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">Z Store</a> - All rights reserved © 2024 - Designed by Thinh and Tai
            <span style="color: #eee; font-weight: bold">group 26th</span></p>
    </div>`);
}
